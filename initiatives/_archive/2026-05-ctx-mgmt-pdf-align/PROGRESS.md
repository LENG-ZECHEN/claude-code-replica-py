...
- **tests**: 670 → 704 (+34; +16 test_snip_tool_model.py [new], +12 test_loop.py, +6 test_context.py, +0 test_agent_integration.py — one existing case was modified in place for the six-tool registry rather than added) [corrected 2026-05-24: the original record claimed `685 → 704 (+19)`; the true M3-post baseline at commit `646bf2c` is 670 and the real delta is +34, verified via `git worktree` + `pytest --collect-only` per file]
